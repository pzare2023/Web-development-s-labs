...
$truncateQuery = "TRUNCATE TABLE photographs";

if (mysqli_query($connect, $truncateQuery)) {
    echo "<div> </div>";
} else {
    echo "<div>Error truncating table: " . mysqli_error($connect) . "</div>";
}
...
$query = "SELECT * FROM photographs ORDER BY date_taken DESC";
$result = mysqli_query($connect, $query);


if (mysqli_num_rows($result) > 0) {
    echo "<h1>Photographs Gallery Sorted By Date</h1>";
    echo "<table border='1' >";
    echo "<tr>
